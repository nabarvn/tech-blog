  ...
  return (
    ...
    >
      ...
      <div className='grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-7 xl:gap-12'>
        <div className='lg:grid lg:grid-cols-8 lg:gap-7 xl:gap-12 col-span-1 md:col-span-6 lg:col-span-8 xl:col-span-9'>
          {posts.map((post) => (
        ...
        <div className='col-span-1 md:col-span-6 lg:col-span-4 xl:col-span-3'>
