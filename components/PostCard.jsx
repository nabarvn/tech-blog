...
const PostCard = ({ post }) => {
  return (
    <div className='flex flex-col bg-white dark:bg-night-gray shadow-lg group transition duration-300 dark:shadow-md hover:shadow-2xl hover:shadow-blue-500 dark:hover:shadow-night-teal rounded-lg p-0 lg:p-5 pb-3 mb-8 lg:mb-0 hover:cursor-pointer'>
