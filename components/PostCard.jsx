  ...
  return (
    <div className='flex flex-col bg-white dark:bg-night-gray shadow-lg group transition duration-300 dark:shadow-md hover:shadow-2xl dark:hover:shadow-night-teal rounded-lg p-0 lg:p-5 pb-3 mb-8 lg:mb-0 hover:cursor-pointer'>
      <Link href={`/post/${post.slug}`}>
        ...
        <h1 className='transition duration-300 text-center mb-8 cursor-pointer dark:text-night-white hover:text-blue-500 dark:group-hover:text-night-teal text-xl md:text-3xl font-semibold px-1 lg:px-0'>
